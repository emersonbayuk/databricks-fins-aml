...
async def get_db_service() -> DatabaseService:
    ...
    if not db_service:
        logger.error("Database service is None - not initialized properly")
        raise HTTPException(status_code=503, detail="Database service unavailable - initialization may have failed")
    return db_service
