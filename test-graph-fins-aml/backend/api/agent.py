...
async def get_agent_service():
    ...
    # For MAS endpoints, we may need to get a token from the SP credentials
    # TODO: Implement SP token generation for MAS endpoints if needed
    # For now, MAS endpoints may not be available without explicit auth
    raise HTTPException(status_code=503, detail="MAS agent authentication needs to be configured for service principal")
